...
export default function Write() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            window.location.replace("https://iwipwq-nest.herokuapp.com/post/" + res.data._id);
        } catch (err) {
            dispatch({type:"PROCESS_FAILURE"})
            console.log(err);
        }
    }
  return (
    <div className="write">
        ...
        <form className="write-form" onSubmit={handleSubmit}>
            ...
            <button className="write-submit" disabled={ isFetching ? true : false }>출판하기</button>
        </form>
    </div>
  )
}
